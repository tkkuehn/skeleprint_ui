...
def angle_finder(num_start_points, circumference, filament_width):
    """Correct the helix angle to nearest value.

    The correction is based on a specific number of start points.
    """
...
def main_gcode(current_layer, filament_width, x2, y, n, layer_height):
    """Print the gcode for each layer."""
    increment_size = 1/n
    mm_per_rev = (10)
